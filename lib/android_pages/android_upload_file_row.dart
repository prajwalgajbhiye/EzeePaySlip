...
//   }
//
//   pw.Widget _earningRow(String title1,
//       String title2,
//       String title3,
//       String title4,
//       String title5,) {
...
//   }
//
//   pw.Widget _grossEarningRow(String title1,
//       String title2,
//       String title3,
//       String title4,) {
//     return pw.Row(
...
//                     padding: const pw.EdgeInsets.only(left: 2),
//                     child: pw.Text(
//                       "Rupees ${convertNumberToWords(
//                           roundedNetSalary.toDouble())} only",
...
//   }
//
//   pw.Widget _buildPdfRowWithFourColumns(String title,
//       String title1,
//       String value1,
//       String title2,
//       String value2,
...
//   }
//
//   pw.Widget _buildRow(String title1,
//       String value1,
//       String title2,
//       String value2,) {
//     return pw.Column(
...
//     const TextStyle subTextStyle = TextStyle(color: Colors.grey);
//
//     Widget buildFileUploadSection() {
//       return Container(
//         height: screenHeight * widget.containerHeightFactor,
//         width: screenWidth * widget.containerWidthFactor,
//         padding: const EdgeInsets.all(16),
//         decoration: BoxDecoration(
//           color: isAndroid ? Colors.grey.shade200 : Colors.grey.shade200,
...
//             ),
//             const SizedBox(height: 10),
//             Text(fileName ?? 'No file selected', style: subTextStyle),
//             const SizedBox(height: 10),
//             Text(
...
//     }
//
//     Widget buildPaymentSlipSection() {
//       return Container(
//         height: screenHeight * widget.containerHeightFactor,
//         width: screenWidth * widget.containerWidthFactor,
//         padding: const EdgeInsets.all(16),
...
//             crossAxisAlignment: CrossAxisAlignment.center,
//             children: [
//               const Text('Generate Payment Slip', style: titleStyle),
//               const SizedBox(height: 10),
//               TextField(
...
//                     flex: 2,
//                     child: ElevatedButton(
//                       onPressed: () => generateAllPaymentSlips(context),
//                       style: ElevatedButton.styleFrom(
//                         backgroundColor: Colors.teal,
//                         padding: const EdgeInsets.all(16),
//                         shape: RoundedRectangleBorder(
...
//                 buildPaymentSlipSection(),
//               ],
//             )
//             : Row(
//           children: [
//             Expanded(child: buildFileUploadSection()),
//             const SizedBox(width: 20),
//             Expanded(child: buildPaymentSlipSection()),
//           ],
//         ),
//
//     );
