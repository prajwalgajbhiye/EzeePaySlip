...
class PaymentSlip extends StatefulWidget {
  ...
  final String arrearWashAll;
  final String arrearSheAll;
  final String arrearMedAll;
  final String serviceAll;
  final String arrearTiffinReimAll;
  final String arrearPerfAll;
  ...
  const PaymentSlip(
      ...
      required this.arrearHraAmount,
      required this.pfAccountNo,
      required this.contractorName,
      required this.arrearWashAll,
      required this.arrearSheAll,
      required this.arrearMedAll,
      required this.serviceAll,
      required this.arrearTiffinReimAll,
      required this.arrearPerfAll});
...
// Function to generate the net salary row in the PDF
  pw.Widget _netSalaryRow(String title1, double netSalary) {
    ...
    final String formattedNetSalary =
        formatter.format(netSalary); // Format the salary
          ...
          return pw.Column(
            ...
            children: [
              pw.Container(
                ...
                pw.Text(widget.contractorName,
                    style: pw.TextStyle(
                        fontSize: 10, fontWeight: pw.FontWeight.bold)),
                pw.Text('WARTHI, BHANDARA',
                    style: const pw.TextStyle(
                        fontSize: 9, color: PdfColors.black)),
                pw.RichText(
                  text: pw.TextSpan(
              ...
              pw.Container(
                ...
                pw.Container(
                    ...
                    child: pw.Column(children: [
                        ...
                        child: pw.Row(
                            ...
                            children: [
                              pw.Column(children: [
                                ...
                                _earningPaymentRow("Perf All", widget.prfRate,
                                    widget.prfAmount),
                                _earningPaymentRow(
                                  "Arrear Perf",
                                  "",
                                  widget.arrearPerfAll,
                                ),
                                _earningPaymentRow("Wash All", widget.washRate,
                                    widget.washAmount),
                                _earningPaymentRow(
                                  "Arrear Wash",
                                  "",
                                  widget.arrearWashAll,
                                ),
                                _earningPaymentRow("SHE All", widget.sheRate,
                                    widget.sheAmount),
                                _earningPaymentRow(
                                  "Arrear SHE",
                                  "",
                                ...
                                _earningPaymentRow("Med All", widget.medRate,
                                    widget.medAmount),
                                _earningPaymentRow(
                                  "Arrear Med",
                                  "",
                      ...
                      _netSalaryRow(
                          "Net Salary :", roundedNetSalary.toDouble()),
                    ])),
                _amountInWord(
                  "Amount in Words : ",
          ...
          children: [
            LayoutBuilder(
              builder: (context, constraints) {
                double containerWidth = isAndroid
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                        ...
                                        children: [
                                          Column(
                                            children: [
                                              ...
                                              EarningPaymentRow(
                                                title1: 'Arrear Perf All',
                                                title2: "",
                                                title3: widget.arrearPerfAll,
                                              ),
                                              EarningPaymentRow(
                                                title1: "Wash All",
                                              ...
                                              EarningPaymentRow(
                                                title1: "Arrear Wash All",
                                                title2: "",
                                                title3: widget.arrearWashAll,
                                              ),
                                              EarningPaymentRow(
                                                title1: "She All",
                                              ...
                                              EarningPaymentRow(
                                                title1: "Arrear She All",
                                                title2: "",
                                                title3: widget.arrearSheAll,
                                              ),
                                              EarningPaymentRow(
                                                title1: "Med All",
                                              ...
                                              EarningPaymentRow(
                                                title1: "Arrear Med All",
                                                title2: "",
                                                title3: widget.arrearMedAll,
                                              ),
                                              EarningPaymentRow(
                                                title1: "Service Allowance",
                                                title2: "",
                                                title3: widget.serviceAll,
                                              ),
                                              EarningPaymentRow(
                                      ...
                                      DetailsRow6(
                                        netSalary:
                                            roundedNetSalary.toStringAsFixed(
                                                2), // Pass the rounded-off value
                                      ),
                                    ],
                                  ),
                                ),
